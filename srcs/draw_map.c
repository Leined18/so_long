...
{
	if (data->direction == 'N')
		mlx_put_image_to_window(data->mlx, data->win, data->images->p_up, (*j) * RES, (*i) * RES);
	else if (data->direction == 'S')
		mlx_put_image_to_window(data->mlx, data->win, data->images->p_down, (*j) * RES, (*i) * RES);
	else if (data->direction == 'E')
		mlx_put_image_to_window(data->mlx, data->win, data->images->p_right, (*j) * RES, (*i) * RES);
	else if (data->direction == 'W')
		mlx_put_image_to_window(data->mlx, data->win, data->images->p_left, (*j) * RES, (*i) * RES);
